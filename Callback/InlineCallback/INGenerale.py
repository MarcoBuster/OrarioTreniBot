...
def callback(bot, chains, update):
    ...
    if callback_q == "inline":
        ...
        bot.api.call(
            "editMessageText",{
                "inline_message_id": inline_message_id, "text": testo, "parse_mode":"HTML",
                "reply_markup":
    ...
    if callback_q == "vota":
        ...
        bot.api.call("editMessageText", {"inline_message_id": inline_message_id, "text": testo, "parse_mode":"Markdown", "reply_markup":\
    ...
    if callback_q == "stats":
        ...
        bot.api.call("editMessageText", {"inline_message_id": inline_message_id, "text": messaggio, "parse_mode":"HTML", "reply_markup":\
                    '{"inline_keyboard":[[{"text":"🔙Torna indietro","callback_data":"home"}]]}'})
